...
:: DOWNLOAD BOTH GOES-EAST and GOES-WEST. and himawari. then append them together into single wallpaper
...
:: GOES18 is west (new, #1) GOES16 is east (original #2). himawari is #4. #3 is placeholder for europe/africa
...
set "wpurl4=https://rammb.cira.colostate.edu/ramsdis/online/images/latest_hi_res/himawari-8/full_disk_ahi_true_color.jpg"
...
set "wppath4=%imgdir%wallpaper4.jpg"
...
PowerShell.exe -Command %scrdir%"dlwp.ps1" -wpurl %wpurl4% -wppath %wppath4%

:: Modify Wallpaper
set "blpath=%scrdir%black.png"

"C:\Program Files\R\R-4.1.1\bin\Rscript.exe" %scrdir%img_modulate_tri.R %wppath1% %wppath2% "" %wppath4% %blpath%
"C:\Program Files\R\R-4.3.0\bin\Rscript.exe" %scrdir%img_modulate_tri.R %wppath1% %wppath2% "" %wppath4% %blpath%
